...
- Image classification, object detection, and digital image processing
- Machine Learning workflows: data preparation, training, evaluation, and deployment
- Cloud computing, virtualization, Linux servers, and SSH
- Network fundamentals, traffic analysis, and network security
- Odoo development, business workflows, approval systems, and audit trails
- Mobile and web application development with clean, maintainable architecture
...
<img src="https://img.shields.io/badge/Java%20Web-ED8B00?style=for-the-badge&logo=openjdk&logoColor=white" alt="Java Web" />
...
<img src="https://img.shields.io/badge/Computer%20Networks-0A66C2?style=for-the-badge" alt="Computer Networks" />
<img src="https://img.shields.io/badge/SSH-231F20?style=for-the-badge&logo=gnubash&logoColor=white" alt="SSH" />
<img src="https://img.shields.io/badge/Network%20Security-2E8B57?style=for-the-badge" alt="Network Security" />
</p>
...
**Focus:** Odoo · Python · Business Workflow · Document Management

</td><td width="50%" valign="top">

### 🏢 Platform & Approval Integration

Enterprise workflow integration featuring authentication, organization context, approval inbox, workflow timeline, safe decisions, and integration testing.

**Focus:** System Integration · REST API · Approval Workflow
...
Mobile development projects covering navigation, layouts, maps, camera APIs, and local notifications.
...
### 🌐 [PPKS Website](https://github.com/TeukuIsmailSyuhada/Website-PPKS)

A web-based information and reporting concept supporting the prevention and handling of sexual violence.

**Focus:** Web Development · UI · Social Impact

</td><td width="50%" valign="top">

### 🛋️ [FURE Furniture](https://github.com/TeukuIsmailSyuhada/FURE_Furniture)

A web application project demonstrating PHP-based development, interface implementation, and database-oriented workflows.

**Focus:** PHP · MySQL · Web Application
